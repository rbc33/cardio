...
heart_db = Chroma(
    # collection_name="heart_disease",
    collection_name="/chroma_db/diad_man",
    embedding_function=embedings,
    persist_directory=chroma_path,
)
# %%
question = "most common heart diseases?"
...
metadata_field_info = [
    AttributeInfo(
        name="source",
        description="data/oxford-handbook-of-cardiology-2nbsped-9780199643219_compress.pdf",
        type="string",
    ),
]
